...
export const agentRoadmap: AgentRoadmapItem[] = [
  ...
  },
  {
    ...
    source: "46 prompts doc",
    note: "Rule 32 and Rule 33 drafting, review routing, issue-aware source retrieval, duplicate suppression, and editable MP approval now exist; the remaining work is concentrated in final language quality and production hardening.",
    completedWork: [
    ...
    remainingWork: [
      "Draft ranking across multiple strong clusters still needs improvement.",
      "Quality must be raised from structurally correct to consistently filing-grade parliamentary language.",
      ...
      "Source retrieval should move from curated official catalogs to stronger issue-specific retrieval and selection.",
    ],
    proofPoints: [
    ...
    nextStep: "Raise the language quality to filing-grade output and improve cluster ranking before expanding to Agent 04.",
  },
