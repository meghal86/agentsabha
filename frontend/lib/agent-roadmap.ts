...
export const agentRoadmap: AgentRoadmapItem[] = [
  ...
  },
  {
    ...
    source: "46 prompts doc",
    note: "Rule 32 and Rule 33 drafting, review routing, and live source retrieval now exist; the remaining work is around ranking, approval workflow, and filing-grade quality.",
    completedWork: [
    ...
    remainingWork: [
      "Source selection should become more issue-text-aware, not only category-aware.",
      ...
      "Duplicate suppression and stronger review escalation rules still need hardening.",
    ],
    proofPoints: [
    ...
    nextStep: "Make source selection issue-aware and finish the MP approval/editing workflow before expanding to Agent 04.",
  },
